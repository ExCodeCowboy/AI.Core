...
namespace TestProblems.TravelingSalesman
{
    ...
    public class TSPTest
    {
        ...
        public void Original()
        {
            ...
            Debug.WriteLine("Number of possible paths = " + citiesData.NumberOfPossiblePaths().ToString("#,###"));
            Debug.WriteLine("Best possible solution (shortest path) length = " + citiesData.ShortestPathLength().ToString("F4"));
        ...
        class Hive
        {
            ...
            public void Solve(bool doProgressBar) // find best Traveling Salesman Problem solution
            {
                ...
                if (pb) Debug.WriteLine("Progress: |==========|"); // 10 units so each symbol is 10% progress
                if (pb) Debug.Write("           ");
                int cycle = 0;
                ...
                if (pb) Debug.WriteLine(""); // end the progress bar
            } // Solve()
    ...
    {
        public Random _random = new Random(1000);
        ...
        public char[] GenerateNeighborMemoryMatrix(char[] memoryMatrix)
        {
            ...
            int adjIndex = _random.Next(0, result.Length);
